      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            // preceding inject step (injectHdr10toDoVi8 returns just {_id: path},
            // no .meta field), so this lookup always silently fell through to the
            ...
            addArg = `${args.inputFileObj.file}:${fps}:dvp=8.1:xps_inband`;
